...
const GLOBAL_VARS = {
    ...
    SUPPORT_IN_PROGRESS_DELAY_MS: process.env.SUPPORT_IN_PROGRESS_DELAY_MS ? Number(process.env.SUPPORT_IN_PROGRESS_DELAY_MS) : 240000,
    SUPPORT_RESOLVED_DELAY_MS: process.env.SUPPORT_RESOLVED_DELAY_MS ? Number(process.env.SUPPORT_RESOLVED_DELAY_MS) : 480000,
    BPP_URL,
    ONIX_BPP_PUBLIC_CALLBACK_URL: process.env.ONIX_BPP_PUBLIC_CALLBACK_URL || '',
    ONIX_BPP_PLUGIN_URL: process.env.ONIX_BPP_PLUGIN_URL || 'http://onix-bpp-plugin:8002',
