...
const GLOBAL_VARS = {
    ...
    SUPPORT_IN_PROGRESS_DELAY_MS: process.env.SUPPORT_IN_PROGRESS_DELAY_MS ? Number(process.env.SUPPORT_IN_PROGRESS_DELAY_MS) : 5000,
    SUPPORT_RESOLVED_DELAY_MS: process.env.SUPPORT_RESOLVED_DELAY_MS ? Number(process.env.SUPPORT_RESOLVED_DELAY_MS) : 10000,
    BPP_URL,
